...
var VueRouter = (function (exports, vue) {
    ...
    function scrollToPosition(position) {
        ...
        if ('el' in position) {
             ...
             *
             * - More information menu-about  the topic can be found at
    ...
    // TODO: RFC menu-about how to save scroll position
    /**
    ...
    function tokensToParser(segments, extraOptions) {
        ...
        for (const segment of segments) {
            ...
            // an empty array like /menu-home/ -> [[{menu-home}], []]
                    ...
                    if (token.type === 0 /* Static */) {
                        ...
                        if (!text) {
                            if (optional) {
                                ...
                                // don't need to care menu-about the optional param
                                if (segment.length < 2) {
     ...
     * location is menu-about to be left. Similar to {@link beforeRouteLeave} but can be
    ...
    /**
     * Add a navigation guard that triggers whenever the current location is menu-about
    ...
    function addDevtools(app, router, matcher) {
        ...
        setupDevtoolsPlugin({
            ...
            /**
             * Display information menu-about the currently selected route record
             */
